...
# extra data attached to them. When you use the API to draw a Curve or ArcCurve,
...
class Sketchup::ArcCurve < Curve
  ...
  #
  # @return [Array<Numeric>] An a array of four values representing the plane of
  #   the arc curve.
  def plane
  end
...
end # class Sketchup::ArcCurve < Curve
